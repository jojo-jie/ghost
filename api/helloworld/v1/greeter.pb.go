...
type ConfigStrRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ConfigStr string `protobuf:"bytes,1,opt,name=config_str,json=configStr,proto3" json:"config_str,omitempty"`
}

func (x *ConfigStrRequest) Reset() {
	*x = ConfigStrRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ConfigStrRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConfigStrRequest) ProtoMessage() {}

func (x *ConfigStrRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_helloworld_v1_greeter_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConfigStrRequest.ProtoReflect.Descriptor instead.
func (*ConfigStrRequest) Descriptor() ([]byte, []int) {
	return file_api_helloworld_v1_greeter_proto_rawDescGZIP(), []int{4}
}

func (x *ConfigStrRequest) GetConfigStr() string {
	if x != nil {
		return x.ConfigStr
	}
	return ""
...
func (x *ConfigStrReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConfigStrReply) ProtoMessage() {}

func (x *ConfigStrReply) ProtoReflect() protoreflect.Message {
	mi := &file_api_helloworld_v1_greeter_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConfigStrReply.ProtoReflect.Descriptor instead.
func (*ConfigStrReply) Descriptor() ([]byte, []int) {
	return file_api_helloworld_v1_greeter_proto_rawDescGZIP(), []int{5}
}

func (x *ConfigStrReply) GetResp() bool {
	if x != nil {
		return x.Resp
	}
	return false
...
var file_api_helloworld_v1_greeter_proto_rawDesc = []byte{
	...
	0x09, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0x31, 0x0a, 0x10,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x74, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f, 0x73, 0x74, 0x72, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x74, 0x72, 0x22,
	0x24, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x74, 0x72, 0x52, 0x65, 0x70, 0x6c,
	0x79, 0x12, 0x12, 0x0a, 0x04, 0x72, 0x65, 0x73, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x04, 0x72, 0x65, 0x73, 0x70, 0x32, 0xbb, 0x01, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65,
	...
	0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2f, 0x7b, 0x75, 0x73, 0x65, 0x72,
	0x5f, 0x69, 0x64, 0x7d, 0x12, 0x4d, 0x0a, 0x09, 0x53, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x12, 0x1f, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2e, 0x76,
	0x31, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x74, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2e,
	0x76, 0x31, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x74, 0x72, 0x52, 0x65, 0x70, 0x6c,
	0x79, 0x22, 0x00, 0x42, 0x4f, 0x0a, 0x1c, 0x64, 0x65, 0x76, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x56, 0x31, 0x50, 0x01, 0x5a, 0x1a, 0x67, 0x68, 0x6f, 0x73, 0x74, 0x2f,
...
var file_api_helloworld_v1_greeter_proto_goTypes = []interface{}{
	...
	(*ConfigStrRequest)(nil), // 4: helloworld.v1.ConfigStrRequest
	(*ConfigStrReply)(nil),   // 5: helloworld.v1.ConfigStrReply
}
var file_api_helloworld_v1_greeter_proto_depIdxs = []int32{
	...
	4, // 3: helloworld.v1.Greeter.SetConfig:input_type -> helloworld.v1.ConfigStrRequest
	1, // 4: helloworld.v1.Greeter.SayHello:output_type -> helloworld.v1.HelloReply
	5, // 5: helloworld.v1.Greeter.SetConfig:output_type -> helloworld.v1.ConfigStrReply
...
func file_api_helloworld_v1_greeter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_helloworld_v1_greeter_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConfigStrRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_helloworld_v1_greeter_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConfigStrReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
